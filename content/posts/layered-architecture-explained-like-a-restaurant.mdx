...
![Request flows from user to router, service, repository, and database.](/assets/blog_assets/layered-architecture/figure-1.png)
...
![A 15 kg request takes 8 kg from batch A and 7 kg from batch B, leaving batch C untouched.](/assets/blog_assets/layered-architecture/figure-3.png)
