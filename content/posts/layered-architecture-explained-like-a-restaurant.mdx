...
![Request flows from user to router, service, repository, and database.](/assets/blog_assets/layered-architecture/figure-1.svg)
...
![Stock consumption validates access and input, locks stock, allocates quantities, and commits balances with ledger entries; failures return errors.](/assets/blog_assets/layered-architecture/figure-2.svg)
...
![A 15 kg request takes 8 kg from batch A and 7 kg from batch B, leaving batch C untouched.](/assets/blog_assets/layered-architecture/figure-3.svg)
...
![Alice locks 10 kg and consumes 7 kg. Bob waits, then sees only 3 kg and rolls back his 7 kg request.](/assets/blog_assets/layered-architecture/figure-4.svg)
